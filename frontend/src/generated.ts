 ...
 */
export const useWriteMinimartBatchRemoveOrder =
 ...
 */
export const useWriteMinimartFulfillOrder =
  /*#__PURE__*/ createUseWriteContract({
    abi: minimartAbi,
...
export const useWriteMinimartRemoveOrder = /*#__PURE__*/ createUseWriteContract(
  { abi: minimartAbi, functionName: 'removeOrder' },
)
 ...
 */
export const useSimulateMinimartAddOrder =
 ...
 */
export const useSimulateMinimartBatchRemoveOrder =
  /*#__PURE__*/ createUseSimulateContract({
    abi: minimartAbi,
    functionName: 'batchRemoveOrder',
  })
 ...
 */
export const useSimulateMinimartFulfillOrder =
  /*#__PURE__*/ createUseSimulateContract({
    abi: minimartAbi,
    functionName: 'fulfillOrder',
  })
 ...
 */
export const useSimulateMinimartRemoveOrder =
  /*#__PURE__*/ createUseSimulateContract({
    abi: minimartAbi,
