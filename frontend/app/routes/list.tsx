...
function SingleToken() {
    ...
    if (!token?.nft) {
        return (
            <div className="flex-grow flex items-center justify-center h-[calc(100vh-64px)] lg:h-[calc(100vh-88px)]">
    ...
    return (
        <div className="relative">
            <div className="flex-grow flex flex-col lg:flex-row overflow-hidden h-[calc(100vh-64px)] lg:h-[calc(100vh-88px)]">
                ...
                {/* Right side: Details and Listing Form */}
                                        ...
                                        <div className="bg-zinc-900/70 border border-zinc-800/80 rounded-xl p-6">
                                            <div className="text-center mb-6">
                                                ...
                                                <p className="text-zinc-400">
                                                    ...
                                                    MiniMart marketplace permission to transfer it
                                                    on your behalf.
                                                </p>
                                            </div>
                                            <ApproveButton
