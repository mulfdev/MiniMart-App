...
export function NftCard({
    ...
    return (
        <div
            className="relative bg-zinc-900 rounded-2xl overflow-hidden h-[530px] max- flex flex-col
                shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgb(0,0,0,0.3)]
                transform hover:-translate-y-2 transition-all duration-500 ease-out border
                border-zinc-800/50 hover:border-zinc-700/80"
        >
            {/* Decorative corner accent */}
            <div
                className="absolute top-0 right-0 w-16 h-16 bg-blue-500/10 rounded-bl-full opacity-0
            ...
            <div className="relative overflow-hidden h-[320px] bg-zinc-800">
                ...
                <div className="absolute inset-0">
                    <img
                        ...
                        alt=""
                        className="w-full h-full object-cover scale-110 blur-xl opacity-30 transform
                            group-hover:scale-125 group-hover:opacity-40 transition-all duration-700
                            ease-out"
                    />
                ...
                <div className="relative w-full h-full flex items-center justify-center p-4">
                    <img
                        ...
                        className="w-full h-full object-contain transform group-hover:scale-105
                            transition-transform duration-700 ease-out filter
                            group-hover:brightness-110 group-hover:contrast-110 drop-shadow-2xl
                            rounded"
                    />
                </div>
                ...
                >
                    <div
                        className="absolute top-1/2 left-1/2 w-96 h-96 -translate-x-1/2
                            -translate-y-1/2"
                    >
                        <div
                            className="absolute inset-0 bg-gradient-conic from-transparent
                                via-white/5 to-transparent animate-spin-slow"
                        />
                    </div>
                </div>
                ...
                <div
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r
                        from-transparent via-white/10 to-transparent transform -skew-x-12
                        -translate-x-full group-hover:translate-x-full transition-transform
                        duration-[1250ms] ease-out"
                />

                <div
                    className="absolute inset-4 border border-white/10 rounded-lg opacity-0
                        group-hover:opacity-100 transition-opacity duration-300"
                />
                ...
                <div className="absolute top-3 left-3 z-10">
                    <div
                        className="flex items-center gap-1 px-2 py-1 bg-black/70 backdrop-blur-sm
            ...
            <div className="p-4 sm:p-6 flex flex-col justify-between flex-1 relative">
                    ...
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <Sparkles
                            className="w-4 h-4 text-yellow-400/60 group-hover:text-yellow-400
                                transition-all duration-300 flex-shrink-0 mt-1 group-hover:rotate-12
                        ...
                        {nft.description ? (
                            <p
                                className="text-zinc-400 text-sm leading-relaxed line-clamp-2
                                    sm:line-clamp-3 group-hover:text-zinc-300 transition-colors
                                    duration-300"
                            >
                                {nft.description}
                            </p>
                ...
                {/* Footer */}
                <div
                    className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gradient-to-r
                        from-zinc-800/50 via-zinc-700/80 to-zinc-800/50 transition-colors
                        duration-300"
                >
                    {orderInfo && (
                        <div
                            className="bg-zinc-900/70 border border-zinc-800/80 rounded-xl p-2 mb-4"
                        >
                            ...
                            <Link to={`/list/${nft.contract.address}/${nft.tokenId}`}>
                                <button
                                    className="group/link flex items-center gap-2 px-6 py-2.5
                                        bg-gradient-to-r from-zinc-800/80 to-zinc-700/80
                                        hover:from-zinc-700/80 hover:to-zinc-600/80 border
                                        border-zinc-700/50 hover:border-zinc-600/80 rounded-xl
                                        font-semibold text-white text-lg transform hover:scale-105
                        ...
                        {variant === 'remove' ? (
                            <button
                                ...
                                className="group/link flex items-center gap-2 px-6 py-2.5
                                    ...
                                    hover:shadow-xl hover:shadow-blue-500/10 disabled:opacity-50
